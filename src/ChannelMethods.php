...
trait ChannelMethods
{
    ...
    {
        return $this->getConnection()->exchangeDeclare($this->getChannelId(), $exchange, $exchangeType, $passive, $durable, $autoDelete, $internal, $nowait, $arguments);
    }
    ...
    {
        return $this->getConnection()->exchangeDelete($this->getChannelId(), $exchange, $ifUnused, $nowait);
    }
    ...
    {
        return $this->getConnection()->exchangeBind($this->getChannelId(), $destination, $source, $routingKey, $nowait, $arguments);
    }
    ...
    {
        return $this->getConnection()->exchangeUnbind($this->getChannelId(), $destination, $source, $routingKey, $nowait, $arguments);
    }
    ...
    {
        return $this->getConnection()->queueDeclare($this->getChannelId(), $queue, $passive, $durable, $exclusive, $autoDelete, $nowait, $arguments);
    }
    ...
    {
        return $this->getConnection()->queueBind($this->getChannelId(), $queue, $exchange, $routingKey, $nowait, $arguments);
    }
    ...
    {
        return $this->getConnection()->queuePurge($this->getChannelId(), $queue, $nowait);
    }
    ...
    {
        return $this->getConnection()->queueDelete($this->getChannelId(), $queue, $ifUnused, $ifEmpty, $nowait);
    }
    ...
    {
        return $this->getConnection()->queueUnbind($this->getChannelId(), $queue, $exchange, $routingKey, $arguments);
    }
    ...
    {
        return $this->getConnection()->qos($this->getChannelId(), $prefetchSize, $prefetchCount, $global);
    }
    ...
    {
        return $this->getConnection()->consume($this->getChannelId(), $queue, $consumerTag, $noLocal, $noAck, $exclusive, $nowait, $arguments);
    }
    ...
    {
        return $this->getConnection()->cancel($this->getChannelId(), $consumerTag, $nowait);
    }
    ...
    {
        return $this->getConnection()->publish($this->getChannelId(), $body, $headers, $exchange, $routingKey, $mandatory, $immediate);
    }
    ...
    {
        return $this->getConnection()->get($this->getChannelId(), $queue, $noAck);
    }
    ...
    {
        return $this->getConnection()->ack($this->getChannelId(), $deliveryTag, $multiple);
    }
    ...
    {
        return $this->getConnection()->reject($this->getChannelId(), $deliveryTag, $requeue);
    }
    ...
    {
        return $this->getConnection()->recoverAsync($this->getChannelId(), $requeue);
    }
    ...
    {
        return $this->getConnection()->recover($this->getChannelId(), $requeue);
    }
    ...
    {
        return $this->getConnection()->nack($this->getChannelId(), $deliveryTag, $multiple, $requeue);
    }
    ...
    {
        return $this->getConnection()->txSelect($this->getChannelId());
    }
    ...
    {
        return $this->getConnection()->txCommit($this->getChannelId());
    }
    ...
    {
        return $this->getConnection()->txRollback($this->getChannelId());
    }
    ...
    {
        return $this->getConnection()->confirmSelect($this->getChannelId(), $nowait);
    }
