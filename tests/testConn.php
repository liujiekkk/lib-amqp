...
$connection->connect()->then(function($connection) use ($loop) {
...
$connection2 = new StreamConnection($loop, $host, $port, $user, $pass, $vhost, 5, 5);
$connection2->connect()->then(function($connection) use ($loop) {
